...
void setup()
{
    ...
    commandArray[0][0] = 200; // Example: Turn after 3 corridors
...
void loop()
{
    ...
    delay(1500);*/ //Debugging line sensor values
}
...
{
    /*the logic should be follow the line if the zumo reads a certain color of line count corridors and turns when commandArray[0][0],
    // which is equal to 100-200-300-...-1000 and commandArray[0][1] is equal to the room number 1-2-3-...-10 it should turn to.
    ...
    case 2:
        ...
        {
            TurnByDegree(180); // turn around 180 degrees
    ...
    case 3:
        ...
        if (lineSensorValues[1] < 500)
        {
            corridorCount++;
            // count corridors
            if (corridorCount == (commandArray[0][1]) || corridorCount == (commandArray[0][1] + 1) || corridorCount == (commandArray[0][1] * 2))
            {
                if (commandArray[0][1] % 2 == 0)
                {
                    // DriveTurn(90, 0); // turn left 90 degrees (0 = right)
